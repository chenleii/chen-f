...
public class SysOrganizationController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "parentId", value = "父级系统组织ID", required = false, dataTypeClass = String.class, paramType = "form"),
            @ApiImplicitParam(name = "name", value = "系统组织名称", required = true, dataTypeClass = String.class, paramType = "form"),
            @ApiImplicitParam(name = "fullName", value = "系统组织全称", required = true, dataTypeClass = String.class, paramType = "form"),
            @ApiImplicitParam(name = "type", value = "系统组织类型", required = true, dataTypeClass = SysOrganizationTypeEnum.class, paramType = "form"),
            @ApiImplicitParam(name = "remark", value = "系统组织备注", required = false, dataTypeClass = String.class, paramType = "form"),
            @ApiImplicitParam(name = "status", value = "系统组织状态", required = true, dataTypeClass = StatusEnum.class, paramType = "form"),
    })
    @PostMapping
