...
import com.chen.f.core.configuration.security.SpringSecurityConfiguration;
import com.chen.f.core.configuration.security.WebSpringSecurityConfiguration;
...
@AutoConfigureAfter({SpringSecurityConfiguration.class, WebSpringSecurityConfiguration.class})
public class EnableChenFAdminSpringSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private final SysApiRolePermissionMapper sysApiRolePermissionMapper;

    public EnableChenFAdminSpringSecurityConfiguration(GrantedAuthorityDefaults grantedAuthorityDefaults,
                                                       SysApiMapper sysApiMapper, SysApiRolePermissionMapper sysApiRolePermissionMapper) {
        this.grantedAuthorityDefaults = grantedAuthorityDefaults;
        this.sysApiMapper = sysApiMapper;
        this.sysApiRolePermissionMapper = sysApiRolePermissionMapper;
    }
