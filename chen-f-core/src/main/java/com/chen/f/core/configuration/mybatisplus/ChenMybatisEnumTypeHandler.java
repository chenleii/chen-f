 ...
 * 自定义枚举属性转换器
 * <p>
 * 复制 {@link com.baomidou.mybatisplus.core.handlers.MybatisEnumTypeHandler}
 * 适配 sharding-jdbc 不支持 {@link java.sql.ResultSet#getObject(java.lang.String, java.lang.Class)}, {@link org.apache.shardingsphere.shardingjdbc.jdbc.unsupported.AbstractUnsupportedOperationResultSet#getObject(java.lang.String, java.lang.Class) }
 *
 * @author chen
 * @since 2021-08-25
 */
public class ChenMybatisEnumTypeHandler<E extends Enum<E>> extends BaseTypeHandler<E> {
    ...
    public ChenMybatisEnumTypeHandler(Class<E> enumClassType) {
